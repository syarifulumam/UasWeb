<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterOperator.aspx.cs" Inherits="Laundry.RegisterOperator" MasterPageFile="~/TemplateWeb.Master" %>
<asp:Content ID="RegisterOperator_content" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="exampleInputPassword1">Password</label>
                  ...
                  <small>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Tidak boleh kosong" ControlToValidate="password" ForeColor="#FF3300"></asp:RequiredFieldValidator>
                  </small>
              </div>
              <div class="form-group">
